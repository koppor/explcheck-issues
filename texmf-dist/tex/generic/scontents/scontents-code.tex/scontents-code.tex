...
%% 
%% Copyright (C) 2019-2026 by Pablo González L <pablgonz@educarchile.cl>
%% 
...
%%                                 scontents-code.tex.
%% 
\def\ScontentsCoreFileDate{2026-06-01}%
\begingroup
  \catcode32=10
  \endlinechar=32
  \def\next{\endgroup}%
...
\keys_define:nn { scontents }
  {
    ...
    debug-var .bool_set:N       = \l__scontents_debug_var_bool,
    debug-var .initial:n        = true,
    debug-var .default:n        = true,
  }
...
\cs_new_protected:Npn \__scontents_store_to_seq:NN #1#2
  {
    \bool_if:NT \l__scontents_debug_var_bool
      {
        \tl_log:N #1
      }
