...
\def\tikzphysics@mech@pulleycenterfill{1.5pt}
...
\tikzset{
  ...
  physics pulley axle radius       = 1.5pt,
...
\tikzphysics@registerkeydefaults{physicspulley}{%
  minimum size/1cm, pulley axle radius/1.5pt, pulley axle color/black}
