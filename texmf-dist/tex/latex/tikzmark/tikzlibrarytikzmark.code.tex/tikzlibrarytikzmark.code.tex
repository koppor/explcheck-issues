...
\tikzset{%
  ...
  tikzmark round/.code={
    \def\tkmk@round{#1}%
    \ifx\tkmk@round\tkmk@off
    \tkmk@round@false
    \else
    \ifx\tkmk@round\tkmk@none
    \tkmk@round@false
    \else
    \tkmk@round@true
    \fi
...
\tikzdeclarecoordinatesystem{pic}{%
  ...
  \@ifundefined{save@pt@\tmk@label}{%
    ...
    \advance\pgf@ya by \pgf@y
    \iftkmk@round@
    \pgfmathsetlength\pgf@xa{floor(\pgf@xa) + round((\pgf@xa - floor(\pgf@xa)) * 10^\tkmk@round)/(10^\tkmk@round)}%
    \pgfmathsetlength\pgf@ya{floor(\pgf@ya) + round((\pgf@ya - floor(\pgf@ya)) * 10^\tkmk@round)/(10^\tkmk@round)}%
    \fi
...
\cs_if_exist:NF \tikz_scan_point:n
{
...
\cs_if_exist:NF \tikz_scan_point:NNn
{
...
\cs_new_nopar:Npn \__sn_process_node:n #1
{
  ...
  {
    \dim_zero:N \l__sn_x_dim
    \dim_zero:N \l__sn_y_dim
  }
