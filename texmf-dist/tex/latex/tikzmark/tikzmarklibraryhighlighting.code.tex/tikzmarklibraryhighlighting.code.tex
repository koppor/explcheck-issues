...
\cs_new_protected_nopar:Npn \tikzmark_start_highlighting:n #1
{
  ...
  \tl_put_right:Nn \l__tikzmark_tmpb_tl {/tikz/highlighter/.cd,#1}
...
\cs_new_protected_nopar:Npn \tikzmark_highlight_or_shunt:nnnn #1#2#3#4
{
  \bool_lazy_all:nT
  {
    {\tl_if_exist_p:c {save@pt@#2}}
    {\tl_if_exist_p:c {save@pg@\tl_use:c{save@pt@#2}}}
    {\tl_if_exist_p:c {save@pt@#3}}
    {\tl_if_exist_p:c {save@pg@\tl_use:c{save@pt@#3}}}
  }
  {
    \int_compare:nTF
    {
      \tl_use:c {save@pg@\tl_use:c{save@pt@#2}}
      >
      \the\value{page}
    }
    {
    ...
    }
    {
      ...
      \int_compare:nTF
      {
        \tl_use:c {save@pg@\tl_use:c{save@pt@#3}}
        =
        \the\value{page}
      }
      {
...
\cs_new_protected_nopar:Npn \tikzmark_process_highlighting:nn #1#2
{
  ...
  \pgfkeysfiltered{/tikz/highlighter/.cd,direction,layer,#1}
...
\tikzset{%
  ...
  /tikz/highlighter/.search also={/tikz,/pgf},
  /tikz/highlighter/highlighter/.is family,
  /tikz/highlighter/highlighter/.search also={/tikz/highlighter,/tikz,/pgf},
  ...
  height/.style={
    /tikz/highlighter/initial height=#1,
    /tikz/highlighter/final height=#1
  },
  depth/.style={
    /tikz/highlighter/initial depth=#1,
    /tikz/highlighter/final depth=#1
  },
  offset/.style={
    /tikz/highlighter/initial offset=#1,
    /tikz/highlighter/final offset=#1
  },
  margin/.style={
    /tikz/highlighter/left margin=#1,
    /tikz/highlighter/right margin=#1,
    /tikz/highlighter/top margin=#1,
    /tikz/highlighter/bottom margin=#1,
  },
...
%% 
%% Copyright (C) 2011-2026 by Andrew Stacey <loopspace@mathforge.org>
%% 
