...
\tikzset{
  ...
  span/.code ~n~ args={3}{
    ...
    } {#1} { \use_none:nn \l__tikzspath_tmpa_tl \l__tikzspath_tmpb_tl }
  },
  ...
  join~ components~ with/.code~2~args={
    ...
    } {#1} { \l__tikzspath_tmpc_tl \use_none:n \l__tikzspath_tmpd_tl  }
  },
  ...
  join~ components~ with~ bezier/.code={
    ...
    } \l__tikzspath_tmpc_tl { \use_none:n \l__tikzspath_tmpd_tl }
  },
  ...
  split~ at~ keep~ middle/.code~ n~ args={3}{
    \__tikzspath_maybe_current_path_reuse:nnn
    {
      \__tikzspath_check_path:nnn
      {
        \spath_split_at_normalised_keep_middle:cnn
      }
    } {#1} { \use_none:nn {#2} {#3} }
  },
  split~ globally~ at~ keep~ middle/.code~ n~ args={3}{
    \__tikzspath_maybe_current_path_reuse:nnn
    {
      \__tikzspath_check_path:nnn
      {
        \spath_gsplit_at_normalised_keep_middle:cnn
      }
    } {#1} { \use_none:nn {#2} {#3} }
  },
  ...
  transform/.code~ 2~ args={
    ...
    } {#1} { \use_none:n \g__tikzspath_smuggle_tl }
  },
  ...
  insert~ gaps~ after~ components/.code~ 2~ args={
    ...
    } {#1} { \use_none:nn \l__tikzspath_tmpc_tl \l__tikzspath_tmpd_tl  }
  },
