...
%4.01d  Propagation des clés pour insertion code piton + factorisation du code
%4.01b  Bugfix sur les clés booléennes
...
\defKV[envpiton]{%
  ...
  PremLigne=\def\CODPITpremligne{#1},firstline=\def\CODPITpremligne{#1},%
  DerLigne=\def\CODPITderligne{#1},lastline=\def\CODPITderligne{#1}
}
...
\defKV[envpcpiton]{%
  ...
  CouleurFond=\colorlet{CODPITcoulfond}{#1},colback=\colorlet{CODPITcoulfond}{#1},%
  PremLigne=\def\CODPITPCpremligne{#1},firstline=\def\CODPITPCpremligne{#1},%
  DerLigne=\def\CODPITPCderligne{#1},lastline=\def\CODPITPCderligne{#1}
}
...
\tcbset{thonnystylelineossimple/.style={%
  thonnystyle,%
  underlay={%
    \begin{tcbclipinterior}
      \draw[draw=none,fill=lightgray!25] (interior.south west) rectangle ([xshift=\pflpitontcboxnumbers]interior.north west) ;
    \end{tcbclipinterior}%
    }
  }
}

\tcbset{thonnypcstylelineossimple/.style={%
  thonnypcstyle,%
  underlay={%
    \begin{tcbclipinterior}
      \draw[draw=none,fill=lightgray!25] (interior.south west) rectangle ([xshift=\pflpitontcboxnumbers]interior.north west) ;
...
%%=============FACTORISATION (macros partagées entre les environnements piton)
% gestion du gobble, réutilisable pour \CODPITgobble ET \CODPITPCgobble
\newcommand\pflSetPitonGobble[1]{%
  \IfStrEqCase{#1}{%
  ...
  \IfInteger{#1}{\PitonOptions{gobble=#1}}{}%
}

% sélection du style tcbox pour CodePiton / pflpitoncode / CodePitonFichier
\newcommand\pflSetPitonStyleBase{%
  \IfSubStr{,Moderne,modern,}{,\CODPITstyle,}%
    {%
      \tcbset{cadre/.style={}}%
      \tcbset{titre/.style={}}%
      \ifboolKV[envpiton]{Lignes}%
        ...
        {\tcbset{stylebase/.style={stylepiton,colframe=CouleurVertForet,colback=CouleurVertForet!5,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign,leftupper=0.25em}}}%
  ...
  \IfSubStr{,Onglet,tab,}{,\CODPITstyle,}%
    {%
      ...
      \ifboolKV[envpiton]{Lignes}%
        ...
        {\tcbset{stylebase/.style={stylepitononglet,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign,leftupper=0.25em}}}%
      \ifboolKV[envpiton]{Filigrane}%
        {\tcbset{filigrane/.style={watermark text={\pflfapython},watermark opacity=0.175,watermark zoom=0.50}}}%
        {\tcbset{filigrane/.style={}}}%
      \SetPitonStyle{Number=\color{\CODPITcolnb}}%
  ...
  \IfSubStr{,Carbon,carbon,}{,\CODPITstyle,}%
    {%
      ...
      \ifboolKV[envpiton]{Lignes}%
        ...
        {\tcbset{stylebase/.style={stylepitonsilicon,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign,leftupper=0.25em}}}%
      \ifboolKV[envpiton]{Filigrane}%
  ...
  \IfSubStr{,CarbonClair,lightcarbon,}{,\CODPITstyle,}%
    {%
      ...
      \ifboolKV[envpiton]{Lignes}%
        ...
        {\tcbset{stylebase/.style={stylepitonsiliconlight,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign,leftupper=0.25em}}}%
      \ifboolKV[envpiton]{Filigrane}%
  ...
  \IfSubStr{,Classique,classic,}{,\CODPITstyle,}%
    {%
      \ifboolKV[envpiton]{Lignes}%
        ...
        {\tcbset{stylebase/.style={thonnystyle,leftupper=0.25em,colframe=darkgray!50!black,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign}}}%
      \ifboolKV[envpiton]{Filigrane}%
...
% coloration des mots-clés du pseudo-code (identique dans les 3 variantes PC)
\newcommand\pflSetPseudoCodeColors{%
  \ifboolKV[envpcpiton]{Couleurs}%
    {%
      ...
      \SetPitonStyle{String = \color{MotsClesPseudoCodeChaine},Comment = \itshape\color{gray}}%
    }%
    {\SetPitonStyle{String = ,Comment = \itshape}}%
}

% sélection du style tcbox pour PseudoCodePiton / pflpseudocodepiton / PseudoCodePitonFichier
\newcommand\pflSetPseudoCodeStyleBase{%
  \IfSubStr{,Moderne,modern,}{,\CODPITPCstyle,}%
    {%
      ...
      \ifboolKV[envpcpiton]{Filigrane}%
        {\tcbset{filigrane/.style={watermark text={\pflfapcode},watermark opacity=0.175,watermark zoom=0.50}}}%
        {\tcbset{filigrane/.style={}}}%
    }%
    {}%
  \IfSubStr{,Onglet,tab,}{,\CODPITPCstyle,}%       % <- corrigé (était "Ongglet" dans PseudoCodePitonFichier)
    {%
      \tcbset{cadre/.style={}}%
...
{%
  ...
  \setKVbooltruedefaultmulti[envpiton]{border}{Cadre}%
  \setKVbooltruedefaultmulti[envpiton]{title bar}{BarreTitre}%
  \ifboolKV[envpiton]{Lignes}%si lignes=true
    ...
    {}%
  \pflSetPitonGobble{\CODPITgobble}%
  \PitonOptions{break-lines,indent-broken-lines,continuation-symbol={\;}}%
  \PitonOptions{background-color=none,prompt-background-color=none}%
  \pflSetPitonStyleBase
...
%%=============CODEPITONSIMPLE (style Classique uniquement, marge = largeur réelle des numéros)
\NewPitonEnvironment{CodePitonSimple}{ O{} m D<>{} }%
{%
  \settowidth{\pflpitontcboxnumbers}{\footnotesize\ttfamily00}%
  \addtolength{\pflpitontcboxnumbers}{2mm}% 1mm de boxsep de chaque côté du numéro
  \tcbset{reset}%
  \useKVdefault[envpiton]%
  \setKV[envpiton]{#1}%
  \setKVbooltruedefaultmulti[envpiton]{lines}{Lignes}%
  ...
  \setKVbooltruedefaultmulti[envpiton]{title bar}{BarreTitre}%
  \ifboolKV[envpiton]{Lignes}%si lignes=true
    {\PitonOptions{left-margin=\pflpitontcboxnumbers,line-numbers={sep=2mm,skip-empty-lines=false,label-empty-lines=true,#3}}}%
    {}%
  \pflSetPitonGobble{\CODPITgobble}%
  \PitonOptions{break-lines,indent-broken-lines,continuation-symbol={\;}}%
  \PitonOptions{background-color=none,prompt-background-color=none}%
  \ifboolKV[envpiton]{Lignes}%
    {\tcbset{stylebase/.style={thonnystylelineossimple,leftupper=0em,colframe=darkgray!50!black,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign}}}%
    {\tcbset{stylebase/.style={thonnystyle,leftupper=0em,colframe=darkgray!50!black,fontupper=\CODPITfonte,fontlower=\CODPITfonte,\CODPITalign}}}%
...
%inputfile
\NewDocumentCommand\CodePitonFichier{ O{} m D<>{} O{} }{%nouvel argument #4 optionnel global à InputPitonFile
  {\tcbset{reset}%
  \useKVdefault[envpiton]%
  \setKV[envpiton]{#1}% on paramètres les nouvelles clés et on les simplifie
  %en/fr
  ...
  \PitonOptions{background-color=none,prompt-background-color=none}%
  \pflSetPitonStyleBase
  \tcolorbox[stylebase,filigrane,cadre,titre,pitonlargeur]
  \IfEq{\CODPITpremligne}{}%
    {%pas de 1ère ligne
      \IfEq{\CODPITderligne}{}%
        {%pas de dernière ligne
          \PitonInputFile[#4]{#2}
        }%
        {%
          \PitonInputFile[last-line=\CODPITderligne,#4]{#2}
        }%
    }%
    {%1ère ligne
      \IfEq{\CODPITderligne}{}%
        {%pas de dernière
          \PitonInputFile[first-line=\CODPITpremligne,#4]{#2}
        }%
        {%dernière
          \PitonInputFile[first-line=\CODPITpremligne,last-line=\CODPITderligne,#4]{#2}
        }%
    }%
  %\PitonInputFile{#2}
  \endtcolorbox}%
...
{%
  ...
  \setKVbooltruedefaultmulti[envpcpiton]{border}{Cadre}%
  \setKVbooltruedefaultmulti[envpcpiton]{title bar}{BarreTitre}%
  \setKVbooltruedefaultmulti[envpcpiton]{color}{Couleurs}%
  \PitonOptions{break-lines,indent-broken-lines,language=minimal,continuation-symbol={\;}}%
  \SetPitonStyle{ Number = }%
  \pflSetPseudoCodeColors
  \ifboolKV[envpcpiton]{Lignes}%si lignes=true
    ...
    {}%
  \pflSetPitonGobble{\CODPITPCgobble}%
  \PitonOptions{background-color=none,prompt-background-color=none}%
  \pflSetPseudoCodeStyleBase
...
\NewPitonEnvironment{PseudoCodePitonSimple}{ O{} m D<>{} }%
{%
  \settowidth{\pflpitontcboxnumbers}{\footnotesize\ttfamily00}
  \addtolength{\pflpitontcboxnumbers}{2mm}% 1mm de boxsep de chaque côté du numéro
  \tcbset{reset}%
  ...
  \pflSetPseudoCodeColors
  \ifboolKV[envpcpiton]{Lignes}%si lignes=true
    {\PitonOptions{left-margin=\pflpitontcboxnumbers,all-line-numbers,line-numbers={sep=2mm,#3}}}%
    {}%
  \pflSetPitonGobble{\CODPITPCgobble}%
  \PitonOptions{background-color=none,prompt-background-color=none}%
  \ifboolKV[envpcpiton]{Lignes}%
    {\tcbset{stylebase/.style={thonnypcstylelineossimple,leftupper=0em,width=\CODPITPClargeur,colframe=darkgray!50!black,fontupper=\CODPITPCfonte,fontlower=\CODPITPCfonte,\CODPITPCalign}}}%
    {\tcbset{stylebase/.style={thonnypcstyle,leftupper=0em,width=\CODPITPClargeur,colframe=darkgray!50!black,fontupper=\CODPITPCfonte,fontlower=\CODPITPCfonte,\CODPITPCalign}}}%
...
%--inputfile
\NewDocumentCommand\PseudoCodePitonFichier{ O{} m D<>{} O{} }{%
  {\tcbset{reset}%
  \useKVdefault[envpcpiton]%
  \setKV[envpcpiton]{#1}% on paramètres les nouvelles clés et on les simplifie
  %en/fr
  ...
  \IfEq{\CODPITPCpremligne}{}%
    {%pas de 1ère ligne
      \IfEq{\CODPITPCderligne}{}%
        {%pas de dernière ligne
          \PitonInputFile[#4]{#2}
        }%
        {%
          \PitonInputFile[last-line=\CODPITPCderligne,#4]{#2}
        }%
    }%
    {%1ère ligne
      \IfEq{\CODPITPCderligne}{}%
        {%pas de dernière
          \PitonInputFile[first-line=\CODPITPCpremligne,#4]{#2}
        }%
        {%dernière
          \PitonInputFile[first-line=\CODPITPCpremligne,last-line=\CODPITPCderligne,#4]{#2}
        }%
    }%
  %\PitonInputFile{#2}%
  \endtcolorbox}%
