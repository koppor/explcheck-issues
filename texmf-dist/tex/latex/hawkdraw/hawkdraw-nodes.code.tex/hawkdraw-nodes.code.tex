...
\msg_new:nnn { hawkdraw } { frame-unknown } {
    Node ~ frame ~ `#1` ~ unknown.
}

\msg_new:nnn { hawkdraw } { text-rendering-mode-unknown } {
    Text ~ rendering ~ mode ~ `#1` ~ unknown.
}
...
\tl_new:N \l__hawkdraw_node_frame_path_tl
\tl_new:N \l_hawkdraw_node_postactions_tl

\bool_new:N \l__hawkdraw_node_background_bool
\coffin_new:N \l_hawkdraw_node_background_coffin

\int_new:N \l__hawkdraw_node_text_rendering_int
\bool_new:N \l__hawkdraw_node_text_rendering_clip_bool
\tl_new:N \l__hawkdraw_node_text_rendering_clip_contents_tl

\clist_new:N \l_hawkdraw_node_anchor_poles_clist
\fp_new:N \l_hawkdraw_node_anchor_degree_fp
...
\tl_new:N \l_hawkdraw_node_color_text_fill_tl
\fp_new:N \l_hawkdraw_node_opacity_text_fill_fp
\tl_new:N \l_hawkdraw_node_color_text_stroke_tl
\fp_new:N \l_hawkdraw_node_opacity_text_stroke_fp
...
\cs_new_protected:Npn \hawkdraw_node_text_rendering_int_set:Nn #1#2 {
    \clist_if_in:nnTF {#2} { none } {
        \int_set:Nn #1 { 3 }
    } {
        \clist_if_in:nnTF {#2} { fill } {
            \clist_if_in:nnTF {#2} { stroke } {
                \clist_if_in:nnTF {#2} { clip } {
                    \int_set:Nn #1 { 6 }
                } {
                    \int_set:Nn #1 { 2 }
                }
...
\keys_define:nn { hawkdraw / path / node } {
    anchor                  .code:n         = {
        \int_compare:nNnTF { \clist_count:n {#1} } > { \c_one_int } {
            \clist_set:Nn \l_hawkdraw_node_anchor_poles_clist {#1}
            \fp_set:Nn \l_hawkdraw_node_anchor_degree_fp { nan }
        } {
            \fp_set:Nn \l_hawkdraw_node_anchor_degree_fp {#1}
        }
    } ,
    ...
    color ~ text            .code:n         = {
        \tl_set:Nn \l_hawkdraw_node_color_text_fill_tl {#1}
        \tl_set_eq:NN \l_hawkdraw_node_color_text_stroke_tl
            \l_hawkdraw_node_color_text_fill_tl
    } ,
    opacity ~ text          .code:n         = {
        \fp_set:Nn \l_hawkdraw_node_opacity_text_fill_fp {#1}
        \fp_set_eq:NN \l_hawkdraw_node_opacity_text_stroke_fp
            \l_hawkdraw_node_opacity_text_fill_fp
    } ,
    color ~ text ~ fill     .tl_set:N       = \l_hawkdraw_node_color_text_fill_tl ,
    color ~ text ~ fill     .initial:n      = { . } ,
    opacity ~ text ~ fill   .fp_set:N       = \l_hawkdraw_node_opacity_text_fill_fp ,
    opacity ~ text ~ fill   .initial:n      = { 1 } ,
    color ~ text ~ stroke   .tl_set:N       = \l_hawkdraw_node_color_text_stroke_tl ,
    color ~ text ~ stroke   .initial:n      = { . } ,
    opacity ~ text ~ stroke .fp_set:N       = \l_hawkdraw_node_opacity_text_stroke_fp ,
    opacity ~ text ~ stroke .initial:n      = { 1 } ,
    ...
    background              .code:n         = {
        \bool_set_true:N \l__hawkdraw_node_background_bool
        \hcoffin_set:Nn \l_hawkdraw_node_background_coffin {#1}
    } ,
    text ~ rendering        .code:n         = {
        \hawkdraw_node_text_rendering_int_set:Nn \l__hawkdraw_node_text_rendering_int {#1}
        \int_compare:nNnT { \l__hawkdraw_node_text_rendering_int } < { 0 } {
            \msg_warning:nnn { hawkdraw } { text-rendering-mode-unknown } {#1}
        }
        \int_compare:nNnT {
            \l__hawkdraw_node_text_rendering_int
        } > { 3 } {
            \bool_set_true:N \l__hawkdraw_node_text_rendering_clip_bool
        }
    } ,
}
...
\cs_new_protected:Npn \hawkdraw_node_contents:n #1 {
    ...
    \color_fill:e { \l_hawkdraw_node_color_text_fill_tl }
    \opacity_fill:V \l_hawkdraw_node_opacity_text_fill_fp
    \color_stroke:e { \l_hawkdraw_node_color_text_stroke_tl }
    \opacity_stroke:V \l_hawkdraw_node_opacity_text_stroke_fp
    \normalfont
...
\dim_new:N \l__hawkdraw_node_width_dim
\dim_new:N \l__hawkdraw_node_height_dim
...
\cs_new_protected:Npn \hawkdraw_node:nn #1#2 {
    \draw_scope_begin:
        ...
        % If text rendering mode is set to clip, we place the contents before the frame is drawn, so that
        % the contents are clipped to the frame. Otherwise, we place the contents after the frame is drawn.
        \bool_if:NTF \l__hawkdraw_node_text_rendering_clip_bool {
            \tl_put_right:Nn \l__hawkdraw_node_text_rendering_clip_contents_tl {
                \hawkdraw_support_pdfliteral:n {
                    \int_use:N \l__hawkdraw_node_text_rendering_int \c_space_tl Tr ~
                }
                \hbox_to_zero:n {
                    % \draw_coffin_use:Nn creates a scope which breaks rendering
                    \coffin_typeset:Nnnnn \l_hawkdraw_node_coffin
                        { hc } { vc } { 0pt } { 0pt }
                }
                \hawkdraw_support_pdfliteral:n { 0 ~ Tr ~ }
            }
        } {
            \hawkdraw_support_pdfliteral:n {
                \int_use:N \l__hawkdraw_node_text_rendering_int \c_space_tl Tr ~
        ...
        \dim_set:Nn \l__hawkdraw_node_width_dim {
            \coffin_wd:N \l_hawkdraw_node_frame_coffin
        }
        \dim_set:Nn \l__hawkdraw_node_height_dim {
            \coffin_ht_plus_dp:N \l_hawkdraw_node_frame_coffin
        }
        \tl_if_blank:VF \l_hawkdraw_point_name_tl {
            \prop_gput:cnV { g__hawkdraw_point_ \l_hawkdraw_point_name_tl _prop }
                { frame } \l_hawkdraw_node_frame_tl
            \prop_gput:cnV { g__hawkdraw_point_ \l_hawkdraw_point_name_tl _prop }
                { width } \l__hawkdraw_node_width_dim
            \prop_gput:cnV { g__hawkdraw_point_ \l_hawkdraw_point_name_tl _prop }
                { height } \l__hawkdraw_node_height_dim
        }
        % Clear the contents box if the text rendering mode is set to clip since it is already
        % placed in the frame box via \l__hawkdraw_node_text_rendering_clip_contents_tl.
        \bool_if:NT \l__hawkdraw_node_text_rendering_clip_bool {
            \coffin_clear:N \l_hawkdraw_node_coffin
        }
                ...
                \bool_if:NTF \l__hawkdraw_node_vbox_bool {
                    \clist_map_inline:Nn \c__hawkdraw_node_vhpoles_clist {
                        \__hawkdraw_node_anchors_gset:NVnnnN
                            ...
                            \l_hawkdraw_node_anchor_poles_clist
                    }
                } {
        ...
        \fp_if_nan:nF { \l_hawkdraw_node_anchor_degree_fp } {
            \fp_sub:Nn \l_hawkdraw_point_at_fp {
                \use:c {
                    hawkdraw_node_frame_point_
                    \l_hawkdraw_node_frame_tl
                    :nnnn
                } {
                    ( 0pt , 0pt )
                } {
                    0.5 \l__hawkdraw_node_width_dim
                } {
                    0.5 \l__hawkdraw_node_height_dim
                } {
                    \l_hawkdraw_node_anchor_degree_fp
                }
            }
        }
        \tl_if_blank:VF \l_hawkdraw_point_name_tl {
        ...
        \draw_coffin_use:NeeV \l_hawkdraw_node_frame_coffin {
            \clist_item:Nn \l_hawkdraw_node_anchor_poles_clist { 1 }
        } {
            \clist_item:Nn \l_hawkdraw_node_anchor_poles_clist { 2 }
        } \l_hawkdraw_point_at_fp
...
\cs_new_protected:Npn \__hawkdraw_node_set_frame:n #1 {
    \hcoffin_set:Nn \l_hawkdraw_node_frame_coffin {
        \draw_suspend_begin:
            ...
            \draw_begin:
                \bool_if:NT \l__hawkdraw_node_text_rendering_clip_bool {
                    \tl_use:N \l__hawkdraw_node_text_rendering_clip_contents_tl
                }

                \cs_if_exist_use:cTF { hawkdraw_node_frame_set_ \l_hawkdraw_node_frame_tl :NNNNVVVV } {
                    \l__hawkdraw_node_frame_path_tl
                    ...
                    \msg_warning:nnV { hawkdraw } { frame-unknown } \l_hawkdraw_node_frame_tl
                }

                \bool_if:NT \l__hawkdraw_node_background_bool {
                    \draw_scope_begin:
                        \tl_use:N \l__hawkdraw_node_frame_path_tl
                        \draw_path_use:n { clip }
                        \draw_coffin_use:Nnn \l_hawkdraw_node_background_coffin { hc } { vc }
                    \draw_scope_end:
                }

                \keys_set_exclude_groups:nnn { hawkdraw / path } { tag } {#1}
                \hawkdraw_path_set_options:
                \tl_use:N \l__hawkdraw_node_frame_path_tl
                \bool_set_false:N \l_draw_bb_update_bool
                \tl_use:N \l_hawkdraw_node_postactions_tl
...
\cs_new_protected:Npn \hawkdraw_node_create_frame:nnn #1#2#3 {
    \cs_new_protected:cpn { hawkdraw_node_frame_set_ #1 :NNNNnnnn } ##1##2##3##4##5##6##7##8 {
        \tl_set:Nn ##1 {#2}
        \dim_set:Nn ##2 {
            \coffin_wd:N ##4 + ##5 + ##6
        }
        \dim_set:Nn ##3 {
            \coffin_ht_plus_dp:N ##4 + ##7 + ##8
        }
    }
    \cs_generate_variant:cn { hawkdraw_node_frame_set_ #1 :NNNNnnnn } { NNNNVVVV }

    \cs_new_protected:cpn { hawkdraw_node_frame_point_ #1 :nnnn } ##1##2##3##4 {
        #3
    }
}
...
\hawkdraw_node_create_frame:nnn { none } { } { ( #1 ) }

\hawkdraw_node_create_frame:nnn { rectangle } {
...
\hawkdraw_node_create_frame:nnn { ellipse } {
...
\hawkdraw_node_create_frame:nnn { circle } {
...
\hawkdraw_node_create_frame:nnn { diamond } {
    \draw_path_moveto:n {
